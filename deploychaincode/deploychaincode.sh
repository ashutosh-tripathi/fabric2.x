...
#commit is based on no. of approvals by orgs...the no. of approvals required is set during deployment in configtx.yaml file in application defaults lscc configurtaion
